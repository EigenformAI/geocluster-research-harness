...
import { activate_specialist_variants } from "./activate_specialist"
...
import { dispatch_specialist_variants } from "./dispatch_specialist"
...
import { request_capability_variants } from "./request_capability"
...
export function registerClineToolSets(): void {
	...
	const allToolVariants = [
		...
		...activate_specialist_variants,
		...dispatch_specialist_variants,
		...request_capability_variants,
	]
