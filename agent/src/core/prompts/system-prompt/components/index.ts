...
import { getGeologicalConstraintsSection } from "./geological_constraints"
import { getMcp } from "./mcp"
import { getObjectiveSection } from "./objective"
import { getRulesSection } from "./rules"
import { getSkillsSection } from "./skills"
import { getSpecialistHistory } from "./specialist_history"
...
export function getSystemPromptComponents() {
	return [
		...
		{
			id: SystemPromptSection.GEOLOGICAL_CONSTRAINTS,
			fn: getGeologicalConstraintsSection,
		},
		...
		{ id: SystemPromptSection.SPECIALIST_HISTORY, fn: getSpecialistHistory },
	]
}
