...
import type { CapabilityGapResult, McpToolFilter, SpecialistResult } from "@/shared/specialists"
...
export interface PromptVariant {
	...
	// Specialist MCP filtering
	readonly mcpToolFilter?: McpToolFilter
}
...
export interface SystemPromptContext {
	...
	readonly activeSpecialist?: string
	readonly agentMode?: string
	readonly specialistHistory?: ReadonlyArray<{
		task_id: string
		specialist: string
		objective: string
...
export interface VariantBuilder {
	...
	mcpToolFilter(filter: McpToolFilter): this
	build(): VariantConfig
}
