...
import { AgentMode, OpenaiReasoningEffort } from "@shared/storage/types"
...
export async function updateSettings(controller: Controller, request: UpdateSettingsRequest): Promise<Empty> {
	try {
		...
		// Update agent mode setting (geology / standard)
		if (request.agentMode !== undefined) {
			controller.stateManager.setGlobalState("agentMode", request.agentMode as AgentMode)
		}
