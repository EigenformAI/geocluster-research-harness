...
// =============================================================================
// Result Marker Protocol (Subagent Output Filtering)
// =============================================================================

/** Start marker for subagent result output */
export const RESULT_MARKER_START = "===RESULT==="

/** End marker for subagent result output */
export const RESULT_MARKER_END = "===END_RESULT==="

// =============================================================================
// Data-Aware Filter Thresholds
// =============================================================================

/** Minimum consecutive tabular lines to trigger collapsing */
export const TABULAR_RUN_MIN_LINES = 5

/** Minimum delimiter consistency ratio to classify as tabular (0-1) */
export const TABULAR_DELIMITER_CONSISTENCY = 0.8
