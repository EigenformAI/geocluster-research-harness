> **Fork notice — Geology Agent.** This directory is a fork of
> [Cline](https://github.com/cline/cline) v3.56.0 (Apache-2.0), modified into
> the geology-specialized agent of the
> [Geocluster Research Harness](https://github.com/EigenformAI/geocluster-research-harness).
> The upstream README below is retained for reference; for what changed, see
> [docs/CHANGES_FROM_ORIGINAL.md](../docs/CHANGES_FROM_ORIGINAL.md). This fork
> is not affiliated with or endorsed by the Cline team.
